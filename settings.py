...
GENERAL_FORECAST_PROMPT = ("По данным новостей сделай прогноз на ближайшее будущее, касающийся тематики криптовалют. Во что инвестировать, что продавать, на какой проект обратить внимание."
