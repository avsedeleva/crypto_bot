...
DIGEST_PROMPT = ("Сделай дайджест всех сообщений из канала. Отбирай не только свежие сообщения, но и более ранние, которые могут оказать значительное влияние на рынок и относятся к теме криптовалют. "
                "Во всех новостях обязательно указывай скрытые ссылки на сообщение из телеграм канала, используя текст-анкор. "
