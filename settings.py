...
GENERAL_DIGEST_PROMPT = ("Сделай дайджест сообщений из каналов, сгруппировав их по тематикам. Общие новости обобщай, не дублируй."
                         "В новостях указывай скрытые ссылки, использую текст-анкор."

                         )
DIGEST_PROMPT = ("Сделай дайджест сообщений из каналов. Отбирай только те сообщения, которые относятся к теме криптовалют. "
                "В новостях указывай скрытые ссылки, использую текст-анкор."
