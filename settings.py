...
PROMPTS = {
    ...
    "analysis":
        ...
        используй ссылки с текстом-анкором.
    ...
    ,
    "trending_tokens": """
        Какие новые токены и свежие проекты сейчас на хайпе. Отдельно обрати внимание на крипто Gems, и молодые и 
        рискованные проекты с потенциалом вырасти во много раз.
        Где возможно, используй ссылки с текстом-анкором.
        """,
    "addition": (
